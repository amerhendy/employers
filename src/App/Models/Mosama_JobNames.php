...
class Mosama_JobNames extends Model
{
    ...
    protected $table ="mosama_job_names";
    ...
    */
    function Mosama_Competencies(){
        return $this->belongsToMany(Mosama_Competencies::class,"mosama_job_name_competencies",'job_name_id','competence_id')->withTrashed();
    }
    ...
    function Mosama_Connections(){
        return $this->belongsToMany(Mosama_Connections::class,"mosama_job_name_connections",'job_name_id','connection_id')->withTrashed();
    }
    function mosama_job_name_connections(){
        return $this->belongsToMany(Mosama_Connections::class,"mosama_jobnames",'id','id');
    }
    function Mosama_Educations(){
        return $this->belongsToMany(Mosama_Educations::class,"mosama_job_name_educations",'job_name_id','education_id')->withTrashed();
    }
    ...
    function Mosama_Experiences(){
        return $this->belongsToMany(Mosama_Experiences::class,"mosama_job_name_experiences",'job_name_id','experience_id')->withTrashed();
    }
    function mosama_job_name_experiences(){
        return $this->belongsToMany(Mosama_Experiences::class,"mosama_jobnames",'id','id');
    }
    function Mosama_Goals(){
        return $this->belongsToMany(Mosama_Goals::class,"mosama_job_name_goals",'job_name_id','goal_id')->withTrashed();
    }
    function mosama_job_name_goals(){
        return $this->belongsToMany(Mosama_Goals::class,"mosama_jobnames",'id','id');
    }
    function Mosama_Managers(){
        return $this->belongsToMany(Mosama_Managers::class,"mosama_job_name_managers",'job_name_id','manager_id')->withTrashed();
    }
    function mosama_job_name_managers(){
        return $this->belongsToMany(Mosama_Managers::class,"mosama_jobnames",'id','id');
    }
    function Mosama_OrgStruses(){
        return $this->belongsToMany(Mosama_OrgStruses::class,"mosama_job_name_org_stru",'job_name_id','org_stru_id')->withTrashed();
    }
    ...
    function Mosama_Skills(){
        return $this->belongsToMany(Mosama_Skills::class,"mosama_job_name_skills",'job_name_id','skill_id')->withTrashed();
    }
    function mosama_job_name_skills(){
        return $this->belongsToMany(Mosama_Skills::class,"mosama_jobnames",'id','id');
    }
    function Mosama_Tasks(){
        return $this->belongsToMany(Mosama_Tasks::class,"mosama_job_name_tasks",'job_name_id','task_id')->withTrashed();
    }
    function mosama_job_name_tasks(){
    ...
    function Mosama_JobTitles(){
        return $this->hasOne(Mosama_JobTitles::class,'id','job_title_id');
    }
