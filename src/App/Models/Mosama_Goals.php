...
class Mosama_Goals extends Model
{
    ...
    */
    ...
    function Mosama_JobTitles(){
        return $this->belongsToMany(Mosama_JobTitles::class,"mosama_job_titles_goals",'goal_id','job_title_id')->withTrashed();
    }
    ...
    function Mosama_JobNames(){
        return $this->belongsToMany(Mosama_JobNames::class,"mosama_job_name_goals",'goal_id','job_name_id')->withTrashed();
    }
