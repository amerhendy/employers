...
class Mosama_Groups extends Model
{
    ...
    */
    function Mosama_Competencies(){
        return $this->belongsToMany(Mosama_Competencies::class,"mosama_groups_competencie",'group_id','competence_id')->withTrashed();
    }
    ...
    function Mosama_Connections(){
        return $this->belongsToMany(Mosama_Connections::class,"mosama_groups_connection",'group_id','connection_id')->withTrashed();
    }
    function mosama_groups_connection(){
        return $this->belongsToMany(Mosama_Connections::class,"mosama_groups",'id','id');
    }
    function Mosama_Degrees(){
        return $this->belongsToMany(Mosama_Degrees::class,"mosama_groups_degree",'group_id','degree_id')->withTrashed();
    }
    function mosama_groups_degree(){
        return $this->belongsToMany(Mosama_Degrees::class,"mosama_groups",'id','id');
    }
    function Mosama_DirectManagers(){
        return $this->belongsToMany(Mosama_Managers::class,"mosama_groups_direct_manager",'group_id','manager_id')->withTrashed();
    }
    function mosama_groups_direct_manager(){
        return $this->belongsToMany(Mosama_Managers::class,"mosama_groups",'id','id');
    }
    function Mosama_Educations(){
        return $this->belongsToMany(Mosama_Educations::class,"mosama_groups_education",'group_id','education_id')->withTrashed();
    }
    ...
    function Mosama_Experiences(){
        return $this->belongsToMany(Mosama_Experiences::class,"mosama_groups_experience",'group_id','experience_id')->withTrashed();
    }
    function mosama_groups_experience(){
    ...
    function Mosama_JobTitles(){
        return $this->belongsToMany(Mosama_JobTitles::class,"mosama_groups_job_titles",'group_id','job_title_id')->withTrashed();
    }
    ...
    function Mosama_OrgStruses(){
        return $this->belongsToMany(Mosama_OrgStruses::class,"mosama_groups_org_stru",'group_id','org_stru_id')->withTrashed();
    }
