...
class Mosama_Connections extends Model
{
    ...
    */
    function Mosama_Groups(){
        return $this->belongsToMany(Mosama_Groups::class,"mosama_groups_connection",'connection_id','group_id')->withTrashed();
    }
    ...
    function Mosama_JobNames(){
        return $this->belongsToMany(Mosama_JobNames::class,"mosama_job_name_connections",'connection_id','job_name_id')->withTrashed();
    }
    ...
    function Mosama_JobTitles(){
        return $this->belongsToMany(Mosama_JobTitles::class,"mosama_job_titles_connection",'connection_id','jobtitle_id')->withTrashed();
    }
