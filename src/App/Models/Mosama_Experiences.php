...
class Mosama_Experiences extends Model
{
    ...
    */
    function Mosama_Degrees(){
        return $this->belongsToMany(Mosama_Degrees::class,"mosama_degrees_experience",'experience_id','degree_id')->withTrashed();
    }
    function mosama_degrees_experience(){
        return $this->belongsToMany(Mosama_Degrees::class,"mosama_experiences",'id','id');
    }
    function Mosama_Groups(){
        return $this->belongsToMany(Mosama_Groups::class,"mosama_groups_experience",'experience_id','group_id')->withTrashed();
    }
    ...
    function Mosama_JobNames(){
        return $this->belongsToMany(Mosama_JobNames::class,"mosama_job_name_experiences",'experience_id','job_name_id')->withTrashed();
    }
