...
class Mosama_Competencies extends Model
{
    use HasFactory,SoftDeletes,AmerTrait,HasRoles,HasApiTokens,HasUuids;
    protected $table ="mosama_competencies";
...
public function sluggable(): array
    ...
    */
    ...
    function mosama_groups_competencies(){
        return $this->belongsToMany(Mosama_Groups::class,"mosama_competencies",'id','id');
    }
    function Mosama_JobNames(){
        return $this->belongsToMany(Mosama_JobNames::class,"mosama_jobnames_competencies",'competence_id','jobname_id')->withTrashed();
    }
    function mosama_jobnames_competencies(){
        return $this->belongsToMany(Mosama_JobNames::class,"mosama_competencies",'id','id');
    }
    ...
    function mosama_jobtitles_competencies(){
        return $this->belongsToMany(Mosama_JobTitles::class,"mosama_competencies",'id','id');
    }
}
