...
class Mosama_Skills extends Model
{
    ...
    */
    ...
    function Mosama_JobNames(){
        return $this->belongsToMany(Mosama_JobNames::class,"mosama_job_name_skills",'skill_id','job_name_id')->withTrashed();
    }
    ...
    function Mosama_JobTitles(){
        return $this->belongsToMany(Mosama_JobTitles::class,"mosama_job_titles_skill",'skill_id','job_title_id')->withTrashed();
    }
