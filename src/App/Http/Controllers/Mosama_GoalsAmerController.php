...
class Mosama_GoalsAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        AMER::setRoute(config('amer.route_prefix') . '/Mosama_Goals');
        ...
        if(amer_user()->can('Mosama_Goals-add') == 0){$this->Amer->denyAccess('create');}
        if(amer_user()->can('Mosama_Goals-trash') == 0){$this->Amer->denyAccess ('trash');}
        if(amer_user()->can('Mosama_Goals-update') == 0){$this->Amer->denyAccess('update');}
        if(amer_user()->can('Mosama_Goals-delete') == 0){$this->Amer->denyAccess('delete');}
        if(amer_user()->can('Mosama_Goals-show') == 0){$this->Amer->denyAccess('show');}
        */
    }
    ...
    public function store(Mosama_GoalsRequest $request)
    {
