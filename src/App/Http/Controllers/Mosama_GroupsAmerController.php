...
class Mosama_GroupsAmerController extends AmerController
{
    ...
    public function setup()
    {
        ...
        AMER::setRoute(config('amer.route_prefix') . '/Mosama_Groups');
    ...
    function groupfields(){
        ...
        AMER::addField([
            ...
            'name'=>['Mosama_Competencies','Mosama_Connections','Mosama_Degrees','Mosama_DirectManagers','Mosama_Educations','Mosama_Experiences','Mosama_Goals',
                    'Mosama_Managers','Mosama_OrgStruses','Mosama_Skills','Mosama_Tasks'],
            'type'=>'Employers::Employers.groups',
            'subfields'=>[
                'Mosama_Competencies'=>[
                    'type'=>'select2_from_ajax','name'=>'Mosama_Competencies','placeholder'=>trans('EMPLANG::Mosama_Competencies.singular'),'entity'=>'Mosama_Competencies',
